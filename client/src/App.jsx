...
const App = () => {
  ...
  const fetchData = async () => {
    setIsLoading(true);
    try {
      const docResponse = await fetch('http://ec2-13-201-35-118.ap-south-1.compute.amazonaws.com:5000/documents');
      if (docResponse.ok) {
        const docData = await docResponse.json();
        setDocuments(docData);
      }
      const reminderResponse = await fetch('http://ec2-13-201-35-118.ap-south-1.compute.amazonaws.com:5000/reminders');
